        ...
        <div class="card">
          <div class="card-body">
            <div class="row align-items-center">
              <div class="col-lg-10">
                <h4 class="card-title ms-0 fw-bold mb-0">CUSTOMER</h4>
              </div>
              <div class="card-top col-lg-2 text-end">
                <a href="add_service.php" class="btn dashboard-btn me-auto btn-sm" style="background-color: #72080f;">Add Customer</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body p-3">
          <div class="row">
            ...
            while ($row = mysqli_fetch_array($run)) {
              ...
              $img = $row["img"];
            ?>
              <div class="col-md-3 customer card-color">
