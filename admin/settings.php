...
<body>
    <div class="row min-vh-100 g-0">
        ...
        <div class="col-lg-10 wrapper">
            ...
            <div class="card custom-card-2 mt-2">
                <div class="card-body p-4">
                    <form method="post" action="functions/functions.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <button type="submit" class="btn btn-success float-end" name="update_settings" style="background-color: #FEB700;">UPDATE</button>
            ...
            <button type="button" class="btn btn-success mt-3" name="change_password" data-bs-toggle="modal" data-bs-target="#myModal" style="background-color: #FEB700;">CHANGE PASSWORD</button>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="functions/functions.php">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" style="background-color: #FEB700;">Close</button>
                        <button type="submit" name="change_password" class="btn btn-primary" style="background-color: #FEB700;">Submit</button>
                    </div>
                </form>
