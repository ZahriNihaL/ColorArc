          ...
          <div class="card-body">
            <div class="row align-items-center">
              ...
              <div class="card-top col-lg-2 text-end">
                <a href="add_testimonial.php" class="btn dashboard-btn me-auto btn-sm" style="background-color: #72080f;">Add Testimonial</a>
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div class="card-body p-2 text-center">
                    ...
                    <div class="d-flex justify-content-center mt-2">
                      <form method="post" action="edit_testimonial.php">
                        ...
                        <button type="submit" name="update_testimonial" class="btn btn-primary me-2" style="background-color: #38303D; border: 0;">Update</button>
                      </form>
