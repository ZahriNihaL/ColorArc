      ...
      <div class="card custom-card-2 mt-3">
        <div class="card-body p-3">
          <div class="row">
            ...
            ?>
              <div class="col-md-3 wishlist card-color">
                <div class="card">
                  <div class="card-body p-2 text-center">
                    ...
                    <div class="d-flex justify-content-center">
                      ...
                      <form method="post" action="assets/functions/functions.php">
                        <input type="hidden" name="id" value="<?php echo $id ?>">
                        <button type="submit" name="delete_wishlist" class="btn btn-danger" onclick="return confirm('Are you sure to delete?');" style="background-color: #ac0404; border: 0;">Delete</button>
                      </form>
                    </div>
                  </div>
                </div>
