        ...
        <div class="col-lg-10 wrapper">
            ...
            <div class="card custom-card-2">
                <div class="card-body p-3 d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 fw-bold">EDIT WISHLIST</h5>
                </div>
            </div>
            ...
            <div class="card custom-card mt-2">
                ...
                <form method="post" action="functions/functions.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="price" id="title" value="<?php echo $price ?>" placeholder="enter the description" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="title">Explanation :</label>
                            <input type="text" class="form-control" name="explanation" id="title" value="<?php echo $explanation ?>" placeholder="enter the description" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <button type="submit" class="btn btn-success float-end" name="update_explanation" style="background-color:#e9b819;">SUBMIT</button>
                        </div>
                    </form>           
                </div>
            </div>
