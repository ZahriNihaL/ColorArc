                    ...
                    <div class="contact-form">
                        ...
                        <form method="POST" action="functions/functions.php">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="phone_number" id="phone_number" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="row location-details">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="flex socialmedia mt-3">
                                <a href=" https://facebook.com/<?php echo $facebook ?>"><i class="fa fa-facebook-f me-3"></i></a>
