                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <p class="para-color text-white"><?php echo $price ?></p>
                                                    <h4 class="card-title fw-bold text-white"><?php echo $explanation ?></h4>
                                                    <p class="card-text text-white"><b class="fw-bold"><?php echo $rating ?></b> to <b
                                                            class="fw-bold"><?php echo $reviews ?></b></p>
                                                    <button class="btn-sm fw-bold ">Shop Now</button>
                                                </div>
                                                <div class="col-lg-4">
                                                    <img src="admin/assets/images/classification/<?php echo $img ?>" alt="offer image"
                                                        class="img-fluid">
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card" style="width: 18rem;">
                            <div class="card-body">
                                ...
                                <div class="product-card-img-bg">
                                    <img src="admin/assets/images/product/<?php echo $img ?>" class="card-img-top" alt="product image">
                                </div>
                                <h5 class="card-title mt-3 fw-bold head-color"><?php echo $product_name ?></h5>
                                <div class="d-flex">
                                    <h6 class=" fw-bold head-color"><?php echo $price ?></h6>
                                    <del>
                                        <h6 class="disabled-rate ms-3"><?php echo $offer_price ?></h6>
                                    </del>
                                </div>
                                <div class="d-flex">
